...
The **Building and Publishing PHP Applications with Windows Azure Web Sites (OS X) Hands-on Lab** is licensed under the terms of the Apache License, Version 2.0.
